...
static uint32 m_aPhasingSpells[] = {SPELL_INSANITY_PHASE_16, SPELL_INSANITY_PHASE_32, SPELL_INSANITY_PHASE_64, SPELL_INSANITY_PHASE_128, SPELL_INSANITY_PHASE_256}; // spells to shift players to different phases
...
struct MANGOS_DLL_DECL boss_volazjAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        //Insanity
        m_uilPlayerGUIDs[0] = 0;
        m_uilPlayerGUIDs[1] = 0;
        m_uilPlayerGUIDs[2] = 0;
        m_uilPlayerGUIDs[3] = 0;
        m_uilPlayerGUIDs[4] = 0;
