...
void AddSC_stormwind_city()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "npc_thargold_ironwing";
    pNewScript->pGossipHello = &GossipHello_npc_thargold_ironwing;
    pNewScript->pGossipSelect = &GossipSelect_npc_thargold_ironwing;
    pNewScript->RegisterSelf();
