...
void AddSC_item_scripts()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "item_complimentary_brewfest_sampler";
    pNewScript->pItemUse = &ItemUse_item_complimentary_brewfest_sampler;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "item_ram_racing_reins";
    pNewScript->pItemUse = &ItemUse_item_ram_racing_reins;
    pNewScript->RegisterSelf();


    pNewScript = new Script;
    pNewScript->Name = "item_tricky_treat";
    pNewScript->pItemUse = &ItemUse_item_tricky_treat;
    pNewScript->RegisterSelf();
}
